...
catwoway scatter yy xx y if j > 0, toptions(name(dots, replace)) poptions(msymbol(p)) save("dots.do", replace)
...
graph twoway ///
	...
	(area yy xx  if y == 5 & j > 0, base(4.6)  ) ///
	(line yy xx  if y == 5 & j < 2, lc(white)  ) ///
	(line yy xx  if y == 5 & j >= 1 & j <= `=2*`NL'+1', lc(gs8) lw(vvthin)) ///
	...
	(area yy xx  if y == 4 & j > 0, base(3.6)  ) ///
	(line yy xx  if y == 4 & j < 2, lc(white)  ) ///
	(line yy xx  if y == 4 & j >= 1 & j <= `=2*`NL'+1', lc(gs8) lw(vvthin)) ///
    ...
    (area yy xx  if y == 3 & j > 0 , base(2.6)  ) ///
	(line yy xx  if y == 3 & j < 2, lc(white)  ) ///
	(line yy xx  if y == 3 & j >= 1 & j <= `=2*`NL'+1', lc(gs8) lw(vvthin)) ///
    ...
    (area yy xx  if y == 2 & j > 0 , base(1.6)  ) ///
	(line yy xx  if y == 2 & j < 2, lc(white)  ) ///
	(line yy xx  if y == 2 & j >= 1 & j <= `=2*`NL'+1', lc(gs8) lw(vvthin)) ///
    ...
    (area yy xx  if y == 1 & j > 0 , base(0.6)  ) ///
	(line yy xx  if y == 1 & j < 2, lc(white)  ) ///
	(line yy xx  if y == 1 & j >= 1 & j <= `=2*`NL'+1', lc(gs8) lw(vvthin)) ///
