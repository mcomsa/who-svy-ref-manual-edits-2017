...
set obs 8
gen neff = 788
replace neff = 461 in 2
replace neff = 306 in 3
replace neff = 220 in 4
replace neff = 167 in 5
replace neff = 131 in 6
replace neff = 106 in 7
replace neff = 89 in 8
...
local plotit  graph twoway ///
  ...
  , legend( off) ///
	 ...
	 xline(70 90, lcolor(gs12) lstyle(foreground))
	 
`plotit'

graph export coverage_80_8_ess_values.png, width(2000) replace
